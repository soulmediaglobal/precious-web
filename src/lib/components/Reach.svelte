  ...
  {:else}
    ...
    >
      ...
      <p class="text-gray-400 mb-8 text-xs leading-relaxed max-w-[90%] font-light">
        Horseback riding along Ratenggaro Beach and exploration of its iconic megalithic village. Swim in the crystal-clear Waekuri
      </p>

      <form class="space-y-5 font-light">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="flex flex-col">
            <label for="firstName" class="text-[10px] mb-1 text-gray-400">First Name</label>
            <input type="text" id="firstName" placeholder="" class="bg-transparent border-0 border-b border-gray-700 pb-1.5 focus:outline-none focus:ring-0 focus:border-white transition-colors text-white placeholder-gray-600 text-sm w-full px-0" />
          </div>
          <div class="flex flex-col">
            <label for="lastName" class="text-[10px] mb-1 text-gray-400">Last name</label>
            <input type="text" id="lastName" placeholder="" class="bg-transparent border-0 border-b border-gray-700 pb-1.5 focus:outline-none focus:ring-0 focus:border-white transition-colors text-white placeholder-gray-600 text-sm w-full px-0" />
          </div>
        </div>

        <div class="flex flex-col">
          <label for="email" class="text-[10px] mb-1 text-gray-400">Email</label>
          <input type="email" id="email" placeholder="" class="bg-transparent border-0 border-b border-gray-700 pb-1.5 focus:outline-none focus:ring-0 focus:border-white transition-colors text-white placeholder-gray-600 text-sm w-full px-0" />
        </div>

        <div class="flex flex-col">
          <label for="phone" class="text-[10px] mb-1 text-gray-400">Phone</label>
          <input type="tel" id="phone" placeholder="" class="bg-transparent border-0 border-b border-gray-700 pb-1.5 focus:outline-none focus:ring-0 focus:border-white transition-colors text-white placeholder-gray-600 text-sm w-full px-0" />
        </div>

        <div class="flex flex-col">
          <label for="message" class="text-[10px] mb-1 text-gray-400">Message</label>
          <textarea id="message" placeholder="" rows="1" class="bg-transparent border-0 border-b border-gray-700 pb-1.5 focus:outline-none focus:ring-0 focus:border-white transition-colors text-white placeholder-gray-600 resize-none text-sm w-full px-0"></textarea>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-8">
          <label class="flex items-start gap-3 cursor-pointer text-[10px] text-gray-400 flex-1 leading-tight pr-2">
            <div class="relative flex items-center justify-center mt-0.5">
              <input type="checkbox" class="peer appearance-none w-4 h-4 border border-gray-600 bg-transparent shrink-0 focus:outline-none focus:ring-1 focus:ring-white transition-colors cursor-pointer" />
