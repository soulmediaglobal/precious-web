...
<form method="POST" enctype="multipart/form-data" class="portfolio-form" onsubmit={() => submitting = true}>
  ...
  <div class="actions"><a class="button" href="/admin/portfolio">Cancel</a><button class="button primary" type="submit" disabled={submitting}>{submitting ? 'Saving…' : submitLabel}</button></div>
</form>
<style>
