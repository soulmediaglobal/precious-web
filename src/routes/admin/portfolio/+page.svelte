...
<svelte:head><title>Portfolio | Precious Admin</title></svelte:head>
<div class="team-page">
  <header class="team-heading">
    <div><p class="breadcrumb"><a href="/admin">Home</a> / Portfolio</p><h1>Portfolio</h1><p class="intro">Manage projects shown on the public Portfolio page.</p></div>
    <a class="button primary" href="/admin/portfolio/new">Add Portfolio</a>
  </header>
  ...
  {#if data.loadError}<div class="notice error" role="alert">{data.loadError} <a href="/admin/portfolio">Retry</a></div>
  {:else}
        ...
        <ul class="member-list">
          {#each data.entries as entry (entry.id)}
            <li class="member">
              ...
              <div class="actions">
                <a class="button" href={`/admin/portfolio/${entry.id}`}>Edit</a>
