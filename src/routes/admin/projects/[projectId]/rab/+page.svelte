...
<nav aria-label="Breadcrumb">
	<a href="/admin/projects">Projects</a> / <a href={`/admin/projects/${data.project.id}`}>{data.project.projectNumber}</a> / RAB
</nav>
<header>
	<div>
...
<div class="workspace" aria-busy={creating || Boolean(navigating.to)}>
	...
	<section class="detail" aria-label="Detail RAB">
		{#if data.selected}
			...
			<a class="open" href={`/admin/projects/${data.project.id}/rab/${rab.id}`}>Open RAB →</a>
