...
<div class="detail-page">
	<nav aria-label="Breadcrumb">
		<a href="/admin-v2/projects">Projects</a> / {data.project.projectNumber}
	</nav>
	<header>
	...
	<section class="panel module">
		...
		<a class="primary" href={`/admin-v2/projects/${data.project.id}/rab`}>Open RAB workspace →</a>
	</section>
	<a href="/admin-v2/projects">← Back to Projects</a>
</div>
