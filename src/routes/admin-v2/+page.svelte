...
<svelte:head>
  <title>Dashboard | Precious Admin v2</title>
</svelte:head>
...
<div class="dashboard">
  ...
  <section class="panel welcome">
    ...
    <nav aria-label="Content shortcuts">
      <a href="/admin-v2/clients">Clients</a>
      <a href="/admin-v2/portfolio">Portfolio</a>
      <a href="/admin-v2/team">Team</a>
      <a href="/admin-v2/contact">Contact Inbox</a>
    </nav>
  </section>
</div>
